    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" required lay-verify="required" class="layui-input" id="id" name="id" value="<%=employee.getId()%>" placeholder="请输入编号"/>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">姓名：</label>
            <div class="layui-input-inline">
                <input type="text" required lay-verify="required" class="layui-input" id='name' value="<%=employee.getName()%>" name="name" placeholder="请输入姓名"/>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select  name="department" lay-verify="required" lay-filter="department" id="department">
                    <option value="<%=employee.getDepartment()%>" selected><%=employee.getDepartment()%></option>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="level" lay-verify="required" lay-filter="level" id="level">
                    <option value="<%=employee.getLevel()%>" selected><%=employee.getLevel()%></option>
        ...
        <div class="layui-form-item">
            <div class="layui-input-inline">
                <input id="addBtn" type="button" class="submit layui-btn layui-btn-md" value="修改"/>
            </div>
        </div>
    </form>
</div>
<script>
    ...
    function addEm() {
        if(verify()){
            ...
            $.post('Servlet?method=updataEm',{"id":id,"name":name,"sex":sex,"department":department,"level":level},function (data) {
                if(data="修改成功"){
                    location.href="showEm.jsp";
                }
            })
        }
    }
